...
<head>
    ...
    <style>
        ...
        .adjacent-table {
            ...
            border-collapse: collapse;
            margin-top: -20px;
            /* Adjusts overlap of the borders */
        }
            ...
            <table class="header" style="width: 100%; border-collapse: collapse; padding-bottom: 15px;">
                <tr>
                    ...
                    <td class="company-details" style="vertical-align: top;padding-left:9%">
                        ...
                        <p style="margin: -1px">66 Soi Sukhumvit 21 Rd. (Asoke), Nort Khlongtoey, Watthana, Bangkok, Thailand 10110</p>
